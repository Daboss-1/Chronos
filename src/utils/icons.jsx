/**
 * Chronos — minimal inline SVG icon set.
 * All icons use currentColor so they inherit the parent's text color.
 * Default size is 16px; pass a `size` prop to override.
 */
...
export function IconMoon({ size = 16 }) {
  return (
    <svg style={base(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconContrast({ size = 16 }) {
  return (
    <svg style={base(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconSignal({ size = 16 }) {
  return (
    <svg style={base(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconRefreshCw({ size = 16 }) {
  return (
    <svg style={base(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconPlay({ size = 16 }) {
  return (
    <svg style={base(size)} viewBox="0 0 24 24" fill="currentColor" stroke="none" aria-hidden="true">
      <polygon points="5 3 19 12 5 21 5 3"/>
    </svg>
  );
}

export function IconPause({ size = 16 }) {
  return (
    <svg style={base(size)} viewBox="0 0 24 24" fill="currentColor" stroke="none" aria-hidden="true">
...
export function IconX({ size = 16 }) {
  return (
    <svg style={base(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export function IconQuestion({ size = 16 }) {
  return (
    <svg style={base(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <circle cx="12" cy="12" r="10"/>
